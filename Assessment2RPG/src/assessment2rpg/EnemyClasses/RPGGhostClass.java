...
public class RPGGhostClass extends RPGEnemyClass {
    public final String name = "Ghost";
    ...
    public void initializeEnemyAbilities(){
        enemyAbility1.add("Ghost Bolt");    //each of these add statements adds the specified text at the next index in the arraylist
        enemyAbility1.add("Fires a bolt of ghostly energy that marks you for death.\n"
                + "Deals 10 Base Damage and inflicts 1 Vulnerable."
                + "[Vulnerable] - take 2x damage from attacks.");
        enemyAbility1.add("10");
        enemyAbility1.add("2");
        enemyAbility2.add("Incorporeal Form");
        enemyAbility2.add("Turns incorporeal to phase through the next attack.");
        enemyAbility2.add("0");
        enemyAbility2.add("3");
        enemyAbility3.add("Ghost Lightning");
        enemyAbility3.add("Spends a turn charging then summons a bolt of unpredictable ghostly lightning.\n"
                + "Deals 2 Base Damage. Hits 3-9 times and inflicts Shocked for each hit."
